                        ...
                        .then((content) => {
                            ...
                            paragraphs.forEach((item) => {
                                ...
                                if (
                                    ...
                                    item.startsWith("Heading") == false &&
                                    item.startsWith("Picture") == false
                                ) {
...
function structurePost(
    ...
    let heading = document.querySelector(
        `${containerNumber} .text-main .text-title a`
    );
    ...
    let headingString_inDetail = document.querySelector(
        `${containerNumber} .modal .modal-title`
    );
    headingString_inDetail.innerHTML = headingString;

    // set date and view
    let date = document.querySelector(
        `${containerNumber} .time_view .time_post span`
    );
    date.innerHTML = dateString;
    let view = document.querySelector(
        `${containerNumber} .time_view .view span`
    );
    ...
    let paragraph_2 = document.querySelector(
        `${containerNumber} .modal .modal-dialog .modal-body p`
    );
    paragraph_2.innerHTML = paragraph_2String;

    // button xem chi tiet
    let buttonDetail = document.querySelector(
        `${containerNumber} .modal .modal-footer button:nth-child(2)`
    );
