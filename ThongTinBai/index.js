...
post_articles('.container-article .container-left .news-in-the-same-category ul', 4, `<div class="line"></div>`);
...
function backPage() {
       let button = document.querySelector('.container-left .back-page span:nth-child(2) ');
...
let btnComent = document.querySelector('.container-article .container-left .coment-container .write-coment .btn-coment');
let btnCancel = document.querySelector('.container-article .container-left .coment-container .write-coment .btn-cancel');
let inpComent = document.querySelector('.container-article .container-left .coment-container .write-coment input');
...
inpComent.addEventListener('blur', () => {
       let text = document.querySelector('.container-article .container-left .coment-container .write-coment input').value;
       if (text === '') {
...
function cancelComent() {
       btnCancel.addEventListener('click', () => {
              document.querySelector('.container-article .container-left .coment-container .write-coment input').value = '';
       });
}
cancelComent();
...
function postStructure(idComent, userName, dateString, valueText, numberLike, numberDislike) {
...
function loadComent(idPost, numberShow) {
       ...
       commentsSortedByDate.forEach((value) => {
              if (value.idPost == idPost && value.state == 1) {
                     ...
                     count += 1;
                     if (count <= numberShow) {
                            postStructure(value.idComent, value.idUser, value.datePost, value.valueText, value.NumberLike, value.NumberDislike);
                     }
              }
       ...
       // watch more
       let moreButton = document.querySelector('.container-article .container-left .coment-container .coment-content  .watch-coment-more');
...
function resetInput() {
       ...
       let passWord = document.querySelector('.form-login form .login-password input');
       let fullName = document.querySelector('.form-login form .login-userName input');
       let repeatPass = document.querySelector('.form-login form .login-repeatpass input');
       userId.value = '';
       passWord.value = '';
       fullName.value = '';
       repeatPass.value = '';
...
function loginForm() {
       ...
       let repeatPass = document.querySelector('.form-login form .login-repeatpass');
...
function warningUserId(message, isShow) {
       ...
       let responseMess = document.querySelector('.form-login form .login-id .warning span');
       if (isShow == true) {
...
function warningPass(message, isShow) {
       let warning = document.querySelector('.form-login form .login-password .warning');
       let responseMess = document.querySelector('.form-login form .login-password .warning span');
       if (isShow == true) {
              warning.style.visibility = 'visible';
              responseMess.innerHTML = message;
       } else {
...
function warningFullName(message, isShow) {
       let warning = document.querySelector('.form-login form .login-userName .warning');
       let responseMess = document.querySelector('.form-login form .login-userName .warning span');
       if (isShow == true) {
              warning.style.visibility = 'visible';
              responseMess.innerHTML = message;
       } else {
...
function warningRepeatPass(message, isShow) {
       let warning = document.querySelector('.form-login form .login-repeatpass .warning');
       let responseMess = document.querySelector('.form-login form .login-repeatpass .warning span');
       if (isShow == true) {
              warning.style.visibility = 'visible';
              responseMess.innerHTML = message;
       } else {
...
function checkRegister(fullName, userId, passWord, repeatPass) {
       if (checkIdUser(userId) == true && checkPass(passWord) == true && checkFullName(fullName) == true && checkRePass(passWord, repeatPass)) {
...
function handleSubmit() {
       ...
       submitButton.addEventListener('click', (event) => {
              event.preventDefault();
              let userId = document.querySelector('.form-login form .login-id input').value;
              let passWord = document.querySelector('.form-login form .login-password input').value;
              let fullName = document.querySelector('.form-login form .login-userName input').value;
              let repeatPass = document.querySelector('.form-login form .login-repeatpass input').value;
              if (userId != '' && passWord != '' && fullName == '' && repeatPass == '') {
