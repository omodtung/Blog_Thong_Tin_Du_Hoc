              ...
              fetch(pathText)
                     ...
                     .then(content => {
                            ...
                            containerPosts.innerHTML = ` ${array.join('')} 
                                   ...
                                   <div class="button-watch-more">
                                          <a href="#" id="${post.id}" onclick="setStatePost(event,'${post.id}')">Xem chi tiết <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                   </div>
...
post_articles('.posts-1 .admissions-news .container-right ul', 3, `<div class="line"></div>`);
postMain_articles('.posts-1 .admissions-news .container-left');
// posts cam nang du hoc
post_articles('.posts-2 .admissions-news .container-right ul', 3, `<div class="line"></div>`);
